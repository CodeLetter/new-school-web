        ...
        <ul class="list-group">
            ...
            <li class="list-group-item list-group-item-action py-1 bg-warning position-relative menu">
                ...
                <ul class="list-group position-absolute w-75 subs" style="z-index:99;display:none;left:100px;top:25px">
                    ...
                    <li class="list-group-item list-group-item-action bg-success py-1"><a href="{{$sub->href}}" style="color:black">{{ $sub->text }}</a></li>
                    @endforeach
                </ul>
                @endisset
            </li>
...
@isset($images)
    ...
    @foreach($images as $img)
        ...
        <div class="img"><img src="{{asset('/'.$img->img)}}"></div>
