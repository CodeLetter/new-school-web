...
// view是後來新增的，如果不用經過controller，可以直接用view回傳前端頁面-視圖。
//Route::view('/','home');
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/* prefix用法,需要在view.backend各開一個*blade.php(一個頁面一個檔案)
Route::prefix('admin')->group(function(){
    Route::view('/','backend.title');
    Route::view('/title','backend.title');
    Route::view('/ad','backend.ad');
    Route::view('/image','backend.image');
    Route::view('/mvim','backend.mvim');
    Route::view('/bottom','backend.bottom');
    Route::view('/news','backend.news');
    Route::view('/admin','backend.admin');
    Route::view('/menu','backend.menu');
});
*/
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// get帶變數,後端很乾淨且方便管理
...
Route::get('/admin/{module}',function($module){
    switch($module){
        ...
        break;
        case "mvim":
            return view('backend.module',['header'=>'動態圖片管理','module'=>'Mvim']);
        break;
        case "total":
...
*/
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Route::prefix('admin')->group(function(){ //這邊加上middleware,保護下面的路由,必須經過認證
Route::prefix('admin')->middleware('auth')->group(function(){ 
    ...
    //update  #(這邊如果方法直接使用post,則比較簡單,但是我們要符合Restful設計風格)
...
/*
//modals(一)
// 這裡注意,因為是使用Route::view,所以不需要加/quiz01/public,而module.blade.php則需要
...
Route::view("/modals/addTotal",'modals.base_modal',['modal_header'=>'新增進站人數']);
Route::view("/modals/addBottom",'modals.base_modal',['modal_header'=>'新增頁尾版權']);
Route::view("/modals/addNews",'modals.base_modal',['modal_header'=>'新增最新消息']);
Route::view("/modals/addAdmin",'modals.base_modal',['modal_header'=>'新增管理管理']);
Route::view("/modals/addMenu",'modals.base_modal',['modal_header'=>'新增選單管理']);
*/
//modals(二)
